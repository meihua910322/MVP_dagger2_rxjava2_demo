...
public class LogUtils {
    ...
    private static String LOG_TAG = "DAE"; // 默认的tag
    ...
    private synchronized static void log2File(String mylogtype, String tag, String text) {
        ...
        String date = new SimpleDateFormat("yyyy-MM-dd").format(nowtime);
        String dateLogContent = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(nowtime) + ":" + mylogtype + ":" + tag + ":" + text; // 日志输出格式
    ...
    public static void delFile() {// 删除日志文件
        String needDelFiel = new SimpleDateFormat("yyyy-MM-dd").format(getDateBefore());
