...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            AppUtils.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS));
        } else {
            AppUtils.getAppContext().startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS));
        }
    }
    ...
    public static String getNetworkOperatorName() {
        TelephonyManager tm = (TelephonyManager) AppUtils.getAppContext()
    ...
    public static String getConnectWifiSsid() {
        if (isWifiConnected()) {
            WifiManager wifiManager = (WifiManager) AppUtils.getAppContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
