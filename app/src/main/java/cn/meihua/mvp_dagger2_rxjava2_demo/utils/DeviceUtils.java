...
//                teleCompany = WordJsonUtils.getStringNull(BaseApplication.wordJsonBean, BaseApplication.wordJsonBean.localization.tel_mobile);
//            } else if (np.startsWith(CU_ISP)) {
//                teleCompany = WordJsonUtils.getStringNull(BaseApplication.wordJsonBean,BaseApplication.wordJsonBean.localization.tel_unicom);
//            } else if (np.startsWith(CT_ISP)) {
//                teleCompany = WordJsonUtils.getStringNull(BaseApplication.wordJsonBean,BaseApplication.wordJsonBean.localization.tel_telecom);
//            }
        }
        return teleCompany;
    }
